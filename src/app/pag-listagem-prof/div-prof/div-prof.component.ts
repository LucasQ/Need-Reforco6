...
profNum: number = 0;
  ...
  profer: infoProf[] = [
    ...
    new infoProf('Vadjo Victor','Doutorado na universidade federal UFPB',
    'Professor de curso preparatório no Descomplica','assets/imagens/professormat2.jpg')
  ]; 
